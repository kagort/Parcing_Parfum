...
urls = [
    'https://parfummaniac.ru/product/pink-molecule-090-09/',
    'https://parfummaniac.ru/product/bois-imperial/',
    'https://parfummaniac.ru/product/ganymedes/'
]  # Замените на нужные URL-адреса

file_name = 'combined_webpage_text.txt'
save_webpage_texts(urls, file_name)
